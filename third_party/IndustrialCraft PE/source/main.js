...
(function (ItemName) {
    ...
    function getItemStorageText(item) {
        ...
        return "".concat(displayEnergy(energy), "/").concat(displayEnergy(capacity), " EU");
    }
...
(function (Machine) {
    var AdvancedMiner = /** @class */ (function (_super) {
        ...
        AdvancedMiner.prototype.updateUi = function () {
            ...
            if (this.data.y < 0) {
                this.container.setText("textInfoXYZ", "X: ".concat(this.data.x, ", Y: ").concat(this.data.y, ", Z: ").concat(this.data.z));
            }
            else {
...
var ItemSeedBag = /** @class */ (function (_super) {
    ...
    ItemSeedBag.prototype.onNameOverride = function (item, name) {
        ...
        if (scanLvl >= 4) {
            newName += "\u00A72Gr: ".concat(extra.getInt("growth"), " \n");
            newName += "\u00A76Ga: ".concat(extra.getInt("gain"), " \n");
            newName += "\u00A7bRe: ".concat(extra.getInt("resistance"));
        }
        if (Game.isDeveloperMode) {
            newName += "\n[DEBUG]scanLevel: ".concat(scanLvl);
        }
        return newName;
    };
...
var ItemElectric = /** @class */ (function (_super) {
    ...
    ItemElectric.prototype.onNameOverride = function (item, name) {
        return "".concat(name, "\n\u00A77").concat(ItemName.getPowerTierText(this.tier), "\n").concat(ItemName.getItemStorageText(item));
    };
    return ItemElectric;
}(ItemCommon));
...
var UpgradeModule = /** @class */ (function (_super) {
    ...
    function UpgradeModule(stringID, name, type) {
        var _this = _super.call(this, stringID, "".concat(name, "_upgrade"), "upgrade_".concat(name)) || this;
        if (type)
            _this.type = type;
...
var ArmorIC2 = /** @class */ (function (_super) {
    ...
    ArmorIC2.prototype.setArmorTexture = function (name) {
        ...
        this.texture = "armor/".concat(name, "_").concat(index, ".png");
    };
    return ArmorIC2;
}(ItemArmor));
...
var DebugItem = /** @class */ (function (_super) {
    ...
    DebugItem.prototype.onItemUse = function (coords, item, block, player) {
        ...
        if (tile) {
            ...
            if (liquid) {
                client.sendMessage("".concat(liquid, " - ").concat(tile.liquidStorage.getAmount(liquid) * 1000, " mB"));
            }
...
var EUMeterUpdatable = /** @class */ (function () {
    ...
    EUMeterUpdatable.prototype.displayValue = function (value) {
        return "".concat(Math.round(value * 100) / 100, " ").concat(this.getUnit());
    };
...
var ItemTransmitter = /** @class */ (function (_super) {
    ...
    ItemTransmitter.prototype.onNameOverride = function (item, name) {
        var extra = item.extra;
        if (extra) {
            name += "\n\u00A77x: ".concat(extra.getInt("x"), ", y: ").concat(extra.getInt("y"), ", z: ").concat(extra.getInt("z"));
        }
        return name;
    };
...
var CropAnalyser = /** @class */ (function (_super) {
    ...
    CropAnalyser.prototype.showCropValues = function (tileEntity, player) {
        ...
        switch (tileEntity.data.scanLevel) {
            case 4:
                client.sendMessage("Growth: ".concat(tileEntity.data.statGrowth));
                client.sendMessage("Gain: ".concat(tileEntity.data.statGain));
                client.sendMessage("Resistance: ".concat(tileEntity.data.statResistance));
            case 2:
...
Logger.Log("IndustrialCraft2 loading finished in ".concat((Debug.sysTime() - startTime), " ms"), "INFO");
