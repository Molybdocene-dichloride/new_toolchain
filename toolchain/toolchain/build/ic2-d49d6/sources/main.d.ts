...
declare namespace Machine {
    interface IMomentOfMomentumConsumer extends TileEntity {
...
declare namespace Machine {
    class KineticGenerator extends Generator implements IMomentOfMomentumConsumer {
        defaultValues: {
            energy: number;
            heat: number;
        };
...
declare namespace Machine {
    class ManualKineticGenerator extends MachineBase {
        onItemClick(): boolean;
        canRotate(): boolean;
    }
}
declare const guiElectricKineticGenerator: UI.StandartWindow;
declare namespace Machine {
    class ElectricKineticGenerator extends ElectricMachine {
        getTier(): number;
        getScreenByName(): UI.IWindow;
        setupContainer(): void;
        calcOutput(): number;
